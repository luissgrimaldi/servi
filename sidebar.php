        ...
        <div class="sidebar" id="sidebar">
            <nav class="sidebar__nav">
                <ul class="sidebar__ul">
                    ...
                    <li onclick="window.location.href = 'listaprecios.php';" class="sidebar__li <?php if(basename($_SERVER['PHP_SELF']) == "listaprecios.php"){ echo "sidebar__li--active";}?>"><a href="listaprecios.php" class="sidebar__a"><i class="fa-solid fa-tags sidebar__emoji"></i>Lista de precios</a></li>
